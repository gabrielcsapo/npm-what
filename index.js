...
module.exports = function(directory, callback) {
    var cmd = path.resolve(__dirname, 'node_modules', '.bin', 'cloc') + ' ' + directory + ' --exclude-dir=node_modules';
    ...
    exec(cmd, function(error, stdout) {
        ...
        output.package = JSON.parse(fs.readFileSync(path.resolve(directory, 'package.json')));
        output.modules_raw = Object.keys(output.package.dependencies ? output.package.dependencies : {}) || [];
        output.modules_raw = output.modules_raw.concat(Object.keys(output.package.devDependencies ? output.package.devDependencies : {}) || []);
        ...
        depcheck(directory, {}, function(unused) {
            ...
            output.modules_raw.forEach(function(mod) {
                ...
                var cmdm = 'echo "module:' + mod + '";' + path.resolve(__dirname, 'node_modules', '.bin', 'cloc') + ' ' + output.modules[mod].dir + ' --exclude-dir=node_modules';
